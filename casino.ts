...
let jugador006: Jugador = new Jugador("María","Fernandez", 12, 75000);
let jugador007: Jugador = new Jugador("James","Bond", 40, 2500000);
let jugador008: Jugador = new Jugador("Luis","Mendez", 46, 115000);
let jugador009: Jugador = new Jugador("Lu","Chi", 74, 555000);
let jugador010: Jugador = new Jugador("Luciana","Velez", 37, 50000);
